            ...
            echo '<section class="','category','" id="','tops','">';
                ...
                echo '<div class="','items','">';
                    ...
                    echo '<div class="image-container">';
                        ...
                        echo '<button class="','button-on-image','" onclick="','alert(','商品が選択されました！',')','">+</button>';
                    echo '</div>';
                        //試験的ボタン実装↑
                        echo '<p>商品名</p>';
                        echo '<p>¥ 価格</p>';
